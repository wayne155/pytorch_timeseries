...
Usage:
    python leaderboard/build_leaderboard.py [--config leaderboard.yaml]
"""
...
def load_config(config_path: pathlib.Path) -> dict[str, Any]:
    ...
    return {
        ...
        "out": str(ROOT / raw.get("out", "webapp/leaderboard/public/leaderboard_data.json")),
    }
...
if __name__ == "__main__":
    ...
    if not cfg_path.exists():
        build({
            ...
            "out": str(ROOT / "webapp/leaderboard/public/leaderboard_data.json"),
        })
    else:
