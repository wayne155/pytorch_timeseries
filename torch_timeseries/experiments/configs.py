...
@dataclass
class DiffTransformerForecasterConfig:
    d_model: int = 64
    n_heads: int = 4
    d_ffn: int = 256
    n_layers: int = 2
    ...
    def validate(self) -> None:
        ...
        if (self.d_model // self.n_heads) % 2 != 0:
            raise ValueError("d_model // n_heads must be even")
        if self.d_ffn <= 0:
            raise ValueError("d_ffn must be positive")
        if self.n_layers <= 0:
            raise ValueError("n_layers must be positive")
...
@dataclass
class FastFormerForecasterConfig:
    d_model: int = 64
    n_heads: int = 4
    d_ffn: int = 256
    n_layers: int = 2
...
class SpikeForecasterConfig:
    ...
    def validate(self) -> None:
        ...
        if self.surrogate_tau <= 0:
            raise ValueError("surrogate_tau must be positive")
        if not (0 <= self.dropout < 1):
            raise ValueError("dropout must be between 0 and 1")


@dataclass
class RWKVForecasterConfig:
    d_model: int = 64
    d_ffn: int = 256
    n_layers: int = 2
    dropout: float = 0.1
...
def split_experiment_config(
    ...
    model_configs = {
        ...
        ("GatedMLPForecaster", "Forecast"): GatedMLPForecasterConfig,
        ...
        ("LiquidNetForecaster", "Forecast"): LiquidNetForecasterConfig,
        ...
        ("AFTForecaster", "Forecast"): AFTForecasterConfig,
        ("AFTForecaster", "AnomalyDetection"): AFTForecasterConfig,
        ("AFTForecaster", "Imputation"): AFTForecasterConfig,
        ("AFTForecaster", "UEAClassification"): AFTForecasterConfig,
        ("RWKVForecaster", "Forecast"): RWKVForecasterConfig,
        ("RWKVForecaster", "AnomalyDetection"): RWKVForecasterConfig,
        ("RWKVForecaster", "Imputation"): RWKVForecasterConfig,
        ("RWKVForecaster", "UEAClassification"): RWKVForecasterConfig,
        ("SpikeForecaster", "Forecast"): SpikeForecasterConfig,
        ...
        ("MinGRUForecaster", "Forecast"): MinGRUForecasterConfig,
        ("MinGRUForecaster", "AnomalyDetection"): MinGRUForecasterConfig,
        ("MinGRUForecaster", "Imputation"): MinGRUForecasterConfig,
        ("MinGRUForecaster", "UEAClassification"): MinGRUForecasterConfig,
        ("FastFormerForecaster", "Forecast"): FastFormerForecasterConfig,
        ...
        ("DiffTransformerForecaster", "Forecast"): DiffTransformerForecasterConfig,
        ("DiffTransformerForecaster", "AnomalyDetection"): DiffTransformerForecasterConfig,
        ("DiffTransformerForecaster", "Imputation"): DiffTransformerForecasterConfig,
        ("DiffTransformerForecaster", "UEAClassification"): DiffTransformerForecasterConfig,
        ("QRNNForecaster", "Forecast"): QRNNForecasterConfig,
        ...
        ("NystromForecaster", "Forecast"): NystromForecasterConfig,
        ("NystromForecaster", "AnomalyDetection"): NystromForecasterConfig,
        ("NystromForecaster", "Imputation"): NystromForecasterConfig,
        ("NystromForecaster", "UEAClassification"): NystromForecasterConfig,
