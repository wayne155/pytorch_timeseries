...
from .wrapper import MultiStepTimeFeatureSet, MultiStepTimeFeatureIndexSet, MultivariateFast, MultivariateFastIndex


class SlidingWindowTimeIndex:
    def __init__(
        self,
    ...
    def _load_dataset(self):
        ...
        self.train_dataset = MultiStepTimeFeatureIndexSet(
            self.train_subset,
            scaler=self.scaler,
            time_enc=self.time_enc,
            window=self.window,
        ...
        if self.fast_val:
            self.val_dataset = MultivariateFastIndex(
                self.val_subset,
                scaler=self.scaler,
                time_enc=self.time_enc,
                window=self.window,
            ...
            self.val_dataset = MultiStepTimeFeatureIndexSet(
                self.val_subset,
                scaler=self.scaler,
                time_enc=self.time_enc,
                window=self.window,
        ...
        if  self.fast_test:
            self.test_dataset = MultivariateFastIndex(
                self.test_subset,
                scaler=self.scaler,
                time_enc=self.time_enc,
                window=self.window,
            ...
            self.test_dataset = MultiStepTimeFeatureIndexSet(
                self.test_subset,
                scaler=self.scaler,
                time_enc=self.time_enc,
                window=self.window,
